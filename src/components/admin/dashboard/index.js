                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <table className="table aiz-table mb-0 footable footable-1 breakpoint-xl" style={{}}>
                                                <tbody>
                                                    <tr>
                                                        <td style={{ display: 'table-cell' }} className="footable-first-visible">Total orders:</td><td style={{ display: 'table-cell' }} className="footable-last-visible">0</td></tr><tr>
                                                        <td style={{ display: 'table-cell' }} className="footable-first-visible">Pending orders:</td><td style={{ display: 'table-cell' }} className="footable-last-visible">0</td></tr><tr>
                                                        <td style={{ display: 'table-cell' }} className="footable-first-visible">Cancelled orders:</td><td style={{ display: 'table-cell' }} className="footable-last-visible">0</td></tr><tr>
                                                        <td style={{ display: 'table-cell' }} className="footable-first-visible">Successful orders:</td><td style={{ display: 'table-cell' }} className="footable-last-visible">0</td></tr></tbody></table>
                                        </div>
                                    </div>
                                </Paper>
                            </div>
                            <div className="col-xl-5 col-md-5">
                                <Paper>
                                    <div className="card p-5 text-center">
                                        <div className="mb-3">
                                            <img loading="lazy" src="/images/verified.png" alt="" width={130} />
                                        </div>
                                    </div>
                                </Paper>
                            </div>
                                ...
                                <div className="col-xl-7 col-md-7">
                                    <Paper>
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                <table className="table aiz-table mb-0 footable footable-2 breakpoint-xl" style={{}}>
                                                    <thead>
                                                        <tr className="footable-header">
                                                            <th style={{ display: 'table-cell' }} className="footable-first-visible">Category</th><th style={{ display: 'table-cell' }} className="footable-last-visible">Product</th></tr>
                                                    </thead>
                                                    <tbody>
                                                        {
                                                            list ?
                                                                list.map((row, index) => (
                                                                    <tr key={index}>
                                                                        <td style={{ display: 'table-cell' }} className="footable-first-visible">{row.category}</td>
                                                                        <td style={{ display: 'table-cell' }} className="footable-last-visible">{row.count}</td>
                                                                    </tr>
                                                                ))
                                                                : "Not found"
                                                        }
                                                ...
                                                <div className="text-center">
                                                        <Button variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/product/create")}> Add new Proudct</Button>
                                                </div>
                                            </div>
                                        </div>
                                    </Paper>
                                    ...
                                    <Grid container >
                                        <Grid item xs={12} sm={12} md={12} lg={12}>
                                            <div className="card mb-4 p-4 text-center">
                                                ...
                                                <Button variant="contained" color="secondary" onClick={()=>this.props.history.push("/admin/shop/list")}>Go to setting</Button>
                                            </div>
                                        </Grid>
                                        <Grid item xs={12} sm={12} md={12} lg={12}>
                                            <div className="card mb-4 p-4 text-center">
                                                ...
                                                <Button variant="contained" color="secondary">Configure Now</Button>
                                                <div>
                                                </div>
                                            </div>
                                        </Grid>
